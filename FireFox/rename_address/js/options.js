...
function saveOptions() {
    ...
    // Se guarda la configuración utilizando el namespace browser y Promesas
    browser.storage.sync.set({ toastEnabled, redirectionConfirmation, autoRedirectSPA })
        .then(() => {
...
function restoreOptions() {
    ...
    browser.storage.sync.get(["toastEnabled", "redirectionConfirmation", "autoRedirectSPA"])
        .then((data) => {
