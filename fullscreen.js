        ...
        if (data.fullscreenEnabled) {
            ...
            if (body.requestFullscreen) {
                try {
                    ...
                    if (hasToShowToast) showToast("Redirección completada y pantalla completa activada.");
                } catch (err) {
                    console.error(err);
                    if (hasToShowToast) showToast("Redirección completada, y la pantalla completa no se pudo activar.");
                }
